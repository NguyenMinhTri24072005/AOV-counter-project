...
const runCrawler = async () => {
    ...
    const rawData = fs.readFileSync(path.join(__dirname, 'run_results.json'), 'utf-8');
    ...
    fs.writeFileSync(path.join(__dirname, 'final_heroes_data.json'), JSON.stringify(finalData, null, 4));
